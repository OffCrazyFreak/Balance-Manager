...
Gui, Add, Tab3, Vtabs -TabStop w%tab_w% h%tab_h% x%tab_x% y%tab_y%, Input|View|Edit
}
...
;======================== Currency Controls ===========================
{
Gui, Add, Text, Vviewtab_currency_text w%currency_text_w% h%controls_h% x%currency_text_x% y%currency_text_y%, Currency:

Gui, Add, DDL, Vviewtab_currency_ddl Gviewtab_currency_ddl -TabStop Choose1 w%currency_ddl_w% r2 x%currency_ddl_x% y%currency_ddl_y%, Kuna|Euro
}
;=================================_====================================
;========================== Date Control ==============================
{
Gui, Add, DDL, Vviewtab_date_ddl Gviewtab_chosen_date w%date_ddl_w% r15 x%date_ddl_x% y%date_ddl_y%
}
;=================================_====================================
;========================= Bills Controls =============================
{
Gui, Add, Picture, Vviewtab_kuna_bill_200_pic ReadOnly w%kuna_bill_200_pic_w% h%controls_h% x%kuna_bill_200_pic_x% y%kuna_bill_200_pic_y%, %A_ScriptDir%\Pictures\200 Kuna.jpg
Gui, Add, Text, Vviewtab_kuna_bill_200_times_text ReadOnly w%kuna_bill_200_times_text_w% h%controls_h% x%kuna_bill_200_times_text_x% y%kuna_bill_200_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bill_200_edit ReadOnly Number Center w%kuna_bill_200_edit_w% h%controls_h% x%kuna_bill_200_edit_x% y%kuna_bill_200_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bill_100_pic ReadOnly w%kuna_bill_100_pic_w% h%controls_h% x%kuna_bill_100_pic_x% y%kuna_bill_100_pic_y%, %A_ScriptDir%\Pictures\100 Kuna.jpg
Gui, Add, Text, Vviewtab_kuna_bill_100_times_text ReadOnly w%kuna_bill_100_times_text_w% h%controls_h% x%kuna_bill_100_times_text_x% y%kuna_bill_100_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bill_100_edit ReadOnly Number Center w%kuna_bill_100_edit_w% h%controls_h% x%kuna_bill_100_edit_x% y%kuna_bill_100_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bill_50_pic ReadOnly w%kuna_bill_50_pic_w% h%controls_h% x%kuna_bill_50_pic_x% y%kuna_bill_50_pic_y%, %A_ScriptDir%\Pictures\50 Kuna.jpg
Gui, Add, Text, Vviewtab_kuna_bill_50_times_text ReadOnly w%kuna_bill_50_times_text_w% h%controls_h% x%kuna_bill_50_times_text_x% y%kuna_bill_50_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bill_50_edit ReadOnly Number Center w%kuna_bill_50_edit_w% h%controls_h% x%kuna_bill_50_edit_x% y%kuna_bill_50_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bill_20_pic ReadOnly w%kuna_bill_20_pic_w% h%controls_h% x%kuna_bill_20_pic_x% y%kuna_bill_20_pic_y%, %A_ScriptDir%\Pictures\20 Kuna.jpg
Gui, Add, Text, Vviewtab_kuna_bill_20_times_text ReadOnly w%kuna_bill_20_times_text_w% h%controls_h% x%kuna_bill_20_times_text_x% y%kuna_bill_20_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bill_20_edit ReadOnly Number Center w%kuna_bill_20_edit_w% h%controls_h% x%kuna_bill_20_edit_x% y%kuna_bill_20_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bill_10_pic ReadOnly w%kuna_bill_10_pic_w% h%controls_h% x%kuna_bill_10_pic_x% y%kuna_bill_10_pic_y%, %A_ScriptDir%\Pictures\10 Kuna.png
Gui, Add, Text, Vviewtab_kuna_bill_10_times_text ReadOnly w%kuna_bill_10_times_text_w% h%controls_h% x%kuna_bill_10_times_text_x% y%kuna_bill_10_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bill_10_edit ReadOnly Number Center w%kuna_bill_10_edit_w% h%controls_h% x%kuna_bill_10_edit_x% y%kuna_bill_10_edit_y%

Gui, Add, Edit, Vviewtab_kuna_bills_sum_edit ReadOnly -TabStop Center w%kuna_bills_sum_edit_w% h%controls_h% x%kuna_bills_sum_edit_x% y%kuna_bills_sum_edit_y%



Gui, Add, Picture, Vviewtab_euro_bill_100_pic ReadOnly w%euro_bill_100_pic_w% h%controls_h% x%euro_bill_100_pic_x% y%euro_bill_100_pic_y%, %A_ScriptDir%\Pictures\100 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bill_100_times_text ReadOnly w%euro_bill_100_times_text_w% h%controls_h% x%euro_bill_100_times_text_x% y%euro_bill_100_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bill_100_edit ReadOnly Number Center w%euro_bill_100_edit_w% h%controls_h% x%euro_bill_100_edit_x% y%euro_bill_100_edit_y%

Gui, Add, Picture, Vviewtab_euro_bill_50_pic ReadOnly w%euro_bill_50_pic_w% h%controls_h% x%euro_bill_50_pic_x% y%euro_bill_50_pic_y%, %A_ScriptDir%\Pictures\50 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bill_50_times_text ReadOnly w%euro_bill_50_times_text_w% h%controls_h% x%euro_bill_50_times_text_x% y%euro_bill_50_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bill_50_edit ReadOnly Number Center w%euro_bill_50_edit_w% h%controls_h% x%euro_bill_50_edit_x% y%euro_bill_50_edit_y%

Gui, Add, Picture, Vviewtab_euro_bill_20_pic ReadOnly w%euro_bill_20_pic_w% h%controls_h% x%euro_bill_20_pic_x% y%euro_bill_20_pic_y%, %A_ScriptDir%\Pictures\20 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bill_20_times_text ReadOnly w%euro_bill_20_times_text_w% h%controls_h% x%euro_bill_20_times_text_x% y%euro_bill_20_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bill_20_edit ReadOnly Number Center w%euro_bill_20_edit_w% h%controls_h% x%euro_bill_20_edit_x% y%euro_bill_20_edit_y%

Gui, Add, Picture, Vviewtab_euro_bill_10_pic ReadOnly w%euro_bill_10_pic_w% h%controls_h% x%euro_bill_10_pic_x% y%euro_bill_10_pic_y%, %A_ScriptDir%\Pictures\10 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bill_10_times_text ReadOnly w%euro_bill_10_times_text_w% h%controls_h% x%euro_bill_10_times_text_x% y%euro_bill_10_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bill_10_edit ReadOnly Number Center w%euro_bill_10_edit_w% h%controls_h% x%euro_bill_10_edit_x% y%euro_bill_10_edit_y%

Gui, Add, Picture, Vviewtab_euro_bill_5_pic ReadOnly w%euro_bill_5_pic_w% h%controls_h% x%euro_bill_5_pic_x% y%euro_bill_5_pic_y%, %A_ScriptDir%\Pictures\5 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bill_5_times_text ReadOnly w%euro_bill_5_times_text_w% h%controls_h% x%euro_bill_5_times_text_x% y%euro_bill_5_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bill_5_edit ReadOnly Number Center w%euro_bill_5_edit_w% h%controls_h% x%euro_bill_5_edit_x% y%euro_bill_5_edit_y%

Gui, Add, Edit, Vviewtab_euro_bills_sum_edit ReadOnly -TabStop Center w%euro_bills_sum_edit_w% h%controls_h% x%euro_bills_sum_edit_x% y%euro_bills_sum_edit_y%
}
;=================================_====================================
;======================== Big Coins Controls ==========================
{
Gui, Add, Picture, Vviewtab_kuna_bigcoin_5_pic ReadOnly w%kuna_bigcoin_5_pic_w% h%controls_h% x%kuna_bigcoin_5_pic_x% y%kuna_bigcoin_5_pic_y%, %A_ScriptDir%\Pictures\5 Kuna.png
Gui, Add, Text, Vviewtab_kuna_bigcoin_5_times_text ReadOnly w%kuna_bigcoin_5_times_text_w% h%controls_h% x%kuna_bigcoin_5_times_text_x% y%kuna_bigcoin_5_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bigcoin_5_edit ReadOnly Number Center w%kuna_bigcoin_5_edit_w% h%controls_h% x%kuna_bigcoin_5_edit_x% y%kuna_bigcoin_5_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bigcoin_2_pic ReadOnly w%kuna_bigcoin_2_pic_w% h%controls_h% x%kuna_bigcoin_2_pic_x% y%kuna_bigcoin_2_pic_y%, %A_ScriptDir%\Pictures\2 Kuna.jpg
Gui, Add, Text, Vviewtab_kuna_bigcoin_2_times_text ReadOnly w%kuna_bigcoin_2_times_text_w% h%controls_h% x%kuna_bigcoin_2_times_text_x% y%kuna_bigcoin_2_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bigcoin_2_edit ReadOnly Number Center w%kuna_bigcoin_2_edit_w% h%controls_h% x%kuna_bigcoin_2_edit_x% y%kuna_bigcoin_2_edit_y%

Gui, Add, Picture, Vviewtab_kuna_bigcoin_1_pic ReadOnly w%kuna_bigcoin_1_pic_w% h%controls_h% x%kuna_bigcoin_1_pic_x% y%kuna_bigcoin_1_pic_y%, %A_ScriptDir%\Pictures\1 Kuna.png
Gui, Add, Text, Vviewtab_kuna_bigcoin_1_times_text ReadOnly w%kuna_bigcoin_1_times_text_w% h%controls_h% x%kuna_bigcoin_1_times_text_x% y%kuna_bigcoin_1_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_bigcoin_1_edit ReadOnly Number Center w%kuna_bigcoin_1_edit_w% h%controls_h% x%kuna_bigcoin_1_edit_x% y%kuna_bigcoin_1_edit_y%

Gui, Add, Edit, Vviewtab_kuna_bigcoins_sum_edit ReadOnly -TabStop Center w%kuna_bigcoins_sum_edit_w% h%controls_h% x%kuna_bigcoins_sum_edit_x% y%kuna_bigcoins_sum_edit_y%



Gui, Add, Picture, Vviewtab_euro_bigcoin_2_pic ReadOnly w%euro_bigcoin_2_pic_w% h%controls_h% x%euro_bigcoin_2_pic_x% y%euro_bigcoin_2_pic_y%, %A_ScriptDir%\Pictures\2 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bigcoin_2_times_text ReadOnly w%euro_bigcoin_2_times_text_w% h%controls_h% x%euro_bigcoin_2_times_text_x% y%euro_bigcoin_2_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bigcoin_2_edit ReadOnly Number Center w%euro_bigcoin_2_edit_w% h%controls_h% x%euro_bigcoin_2_edit_x% y%euro_bigcoin_2_edit_y%

Gui, Add, Picture, Vviewtab_euro_bigcoin_1_pic ReadOnly w%euro_bigcoin_1_pic_w% h%controls_h% x%euro_bigcoin_1_pic_x% y%euro_bigcoin_1_pic_y%, %A_ScriptDir%\Pictures\1 Euro.jpg
Gui, Add, Text, Vviewtab_euro_bigcoin_1_times_text ReadOnly w%euro_bigcoin_1_times_text_w% h%controls_h% x%euro_bigcoin_1_times_text_x% y%euro_bigcoin_1_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_bigcoin_1_edit ReadOnly Number Center w%euro_bigcoin_1_edit_w% h%controls_h% x%euro_bigcoin_1_edit_x% y%euro_bigcoin_1_edit_y%

Gui, Add, Edit, Vviewtab_euro_bigcoins_sum_edit ReadOnly -TabStop Center w%euro_bigcoins_sum_edit_w% h%controls_h% x%euro_bigcoins_sum_edit_x% y%euro_bigcoins_sum_edit_y%
}
;=================================_====================================
;======================= Small Coins Controls =========================
{
Gui, Add, Picture, Vviewtab_kuna_smallcoin_50_pic ReadOnly w%kuna_smallcoin_50_pic_w% h%controls_h% x%kuna_smallcoin_50_pic_x% y%kuna_smallcoin_50_pic_y%, %A_ScriptDir%\Pictures\50 Lipa.png
Gui, Add, Text, Vviewtab_kuna_smallcoin_50_times_text ReadOnly w%kuna_smallcoin_50_times_text_w% h%controls_h% x%kuna_smallcoin_50_times_text_x% y%kuna_smallcoin_50_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_smallcoin_50_edit ReadOnly Number Center w%kuna_smallcoin_50_edit_w% h%controls_h% x%kuna_smallcoin_50_edit_x% y%kuna_smallcoin_50_edit_y%

Gui, Add, Picture, Vviewtab_kuna_smallcoin_20_pic ReadOnly w%kuna_smallcoin_20_pic_w% h%controls_h% x%kuna_smallcoin_20_pic_x% y%kuna_smallcoin_20_pic_y%, %A_ScriptDir%\Pictures\20 Lipa.png
Gui, Add, Text, Vviewtab_kuna_smallcoin_20_times_text ReadOnly w%kuna_smallcoin_20_times_text_w% h%controls_h% x%kuna_smallcoin_20_times_text_x% y%kuna_smallcoin_20_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_smallcoin_20_edit ReadOnly Number Center w%kuna_smallcoin_20_edit_w% h%controls_h% x%kuna_smallcoin_20_edit_x% y%kuna_smallcoin_20_edit_y%

Gui, Add, Picture, Vviewtab_kuna_smallcoin_10_pic ReadOnly w%kuna_smallcoin_10_pic_w% h%controls_h% x%kuna_smallcoin_10_pic_x% y%kuna_smallcoin_10_pic_y%, %A_ScriptDir%\Pictures\10 Lipa.jpg
Gui, Add, Text, Vviewtab_kuna_smallcoin_10_times_text ReadOnly w%kuna_smallcoin_10_times_text_w% h%controls_h% x%kuna_smallcoin_10_times_text_x% y%kuna_smallcoin_10_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_smallcoin_10_edit ReadOnly Number Center w%kuna_smallcoin_10_edit_w% h%controls_h% x%kuna_smallcoin_10_edit_x% y%kuna_smallcoin_10_edit_y%

Gui, Add, Picture, Vviewtab_kuna_smallcoin_5_pic ReadOnly w%kuna_smallcoin_5_pic_w% h%controls_h% x%kuna_smallcoin_5_pic_x% y%kuna_smallcoin_5_pic_y%, %A_ScriptDir%\Pictures\5 Lipa.png
Gui, Add, Text, Vviewtab_kuna_smallcoin_5_times_text ReadOnly w%kuna_smallcoin_5_times_text_w% h%controls_h% x%kuna_smallcoin_5_times_text_x% y%kuna_smallcoin_5_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_smallcoin_5_edit ReadOnly Number Center w%kuna_smallcoin_5_edit_w% h%controls_h% x%kuna_smallcoin_5_edit_x% y%kuna_smallcoin_5_edit_y%

Gui, Add, Picture, Vviewtab_kuna_smallcoin_1_pic ReadOnly w%kuna_smallcoin_1_pic_w% h%controls_h% x%kuna_smallcoin_1_pic_x% y%kuna_smallcoin_1_pic_y%, %A_ScriptDir%\Pictures\1 Lipa.jpg
Gui, Add, Text, Vviewtab_kuna_smallcoin_1_times_text ReadOnly w%kuna_smallcoin_1_times_text_w% h%controls_h% x%kuna_smallcoin_1_times_text_x% y%kuna_smallcoin_1_times_text_y%, x
Gui, Add, Edit, Vviewtab_kuna_smallcoin_1_edit ReadOnly Number Center w%kuna_smallcoin_1_edit_w% h%controls_h% x%kuna_smallcoin_1_edit_x% y%kuna_smallcoin_1_edit_y%

Gui, Add, Edit, Vviewtab_kuna_smallcoins_sum_edit ReadOnly -TabStop Center w%kuna_smallcoins_sum_edit_w% h%controls_h% x%kuna_smallcoins_sum_edit_x% y%kuna_smallcoins_sum_edit_y%



Gui, Add, Picture, Vviewtab_euro_smallcoin_50_pic ReadOnly w%euro_smallcoin_50_pic_w% h%controls_h% x%euro_smallcoin_50_pic_x% y%euro_smallcoin_50_pic_y%, %A_ScriptDir%\Pictures\50 Cents.jpg
Gui, Add, Text, Vviewtab_euro_smallcoin_50_times_text ReadOnly w%euro_smallcoin_50_times_text_w% h%controls_h% x%euro_smallcoin_50_times_text_x% y%euro_smallcoin_50_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_smallcoin_50_edit ReadOnly Number Center w%euro_smallcoin_50_edit_w% h%controls_h% x%euro_smallcoin_50_edit_x% y%euro_smallcoin_50_edit_y%

Gui, Add, Picture, Vviewtab_euro_smallcoin_20_pic ReadOnly w%euro_smallcoin_20_pic_w% h%controls_h% x%euro_smallcoin_20_pic_x% y%euro_smallcoin_20_pic_y%, %A_ScriptDir%\Pictures\20 Cents.jpg
Gui, Add, Text, Vviewtab_euro_smallcoin_20_times_text ReadOnly w%euro_smallcoin_20_times_text_w% h%controls_h% x%euro_smallcoin_20_times_text_x% y%euro_smallcoin_20_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_smallcoin_20_edit ReadOnly Number Center w%euro_smallcoin_20_edit_w% h%controls_h% x%euro_smallcoin_20_edit_x% y%euro_smallcoin_20_edit_y%

Gui, Add, Picture, Vviewtab_euro_smallcoin_10_pic ReadOnly w%euro_smallcoin_10_pic_w% h%controls_h% x%euro_smallcoin_10_pic_x% y%euro_smallcoin_10_pic_y%, %A_ScriptDir%\Pictures\10 Cents.jpg
Gui, Add, Text, Vviewtab_euro_smallcoin_10_times_text ReadOnly w%euro_smallcoin_10_times_text_w% h%controls_h% x%euro_smallcoin_10_times_text_x% y%euro_smallcoin_10_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_smallcoin_10_edit ReadOnly Number Center w%euro_smallcoin_10_edit_w% h%controls_h% x%euro_smallcoin_10_edit_x% y%euro_smallcoin_10_edit_y%

Gui, Add, Picture, Vviewtab_euro_smallcoin_5_pic ReadOnly w%euro_smallcoin_5_pic_w% h%controls_h% x%euro_smallcoin_5_pic_x% y%euro_smallcoin_5_pic_y%, %A_ScriptDir%\Pictures\5 Cents.jpg
Gui, Add, Text, Vviewtab_euro_smallcoin_5_times_text ReadOnly w%euro_smallcoin_5_times_text_w% h%controls_h% x%euro_smallcoin_5_times_text_x% y%euro_smallcoin_5_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_smallcoin_5_edit ReadOnly Number Center w%euro_smallcoin_5_edit_w% h%controls_h% x%euro_smallcoin_5_edit_x% y%euro_smallcoin_5_edit_y%

Gui, Add, Picture, Vviewtab_euro_smallcoin_1_pic ReadOnly w%euro_smallcoin_1_pic_w% h%controls_h% x%euro_smallcoin_1_pic_x% y%euro_smallcoin_1_pic_y%, %A_ScriptDir%\Pictures\1 Cent.jpg
Gui, Add, Text, Vviewtab_euro_smallcoin_1_times_text ReadOnly w%euro_smallcoin_1_times_text_w% h%controls_h% x%euro_smallcoin_1_times_text_x% y%euro_smallcoin_1_times_text_y%, x
Gui, Add, Edit, Vviewtab_euro_smallcoin_1_edit ReadOnly Number Center w%euro_smallcoin_1_edit_w% h%controls_h% x%euro_smallcoin_1_edit_x% y%euro_smallcoin_1_edit_y%

Gui, Add, Edit, Vviewtab_euro_smallcoins_sum_edit ReadOnly -TabStop Center w%euro_smallcoins_sum_edit_w% h%controls_h% x%euro_smallcoins_sum_edit_x% y%euro_smallcoins_sum_edit_y%
}
;=================================_====================================
;========================== Bank Controls =============================
{
Gui, Add, Text, Vviewtab_bank_text w%bank_text_w% h%controls_h% x%bank_text_x% y%bank_text_y%, Bank:

Gui, Add, Edit, Vviewtab_bank_edit ReadOnly Center w%bank_edit_w% h%controls_h% x%bank_edit_x% y%bank_edit_y%
}
;=================================_====================================
;======================= Calculation Controls =========================
{
Gui, Add, Text, Vviewtab_kuna_text w%kuna_text_w% h%controls_h% x%kuna_text_x% y%kuna_text_y%, Kuna:

Gui, Add, Edit, Vviewtab_kuna_edit ReadOnly -TabStop Center w%kuna_edit_w% h%controls_h% x%kuna_edit_x% y%kuna_edit_y%

;=================================_====================================

Gui, Add, Text, Vviewtab_euro_text w%euro_text_w% h%controls_h% x%euro_text_x% y%euro_text_y%, Euro:

Gui, Add, Edit, Vviewtab_euro_edit ReadOnly -TabStop Center w%euro_edit_w% h%controls_h% x%euro_edit_x% y%euro_edit_y%
}
;=================================_====================================
;========================== Print Button ==============================
{
Gui, Add, Button, Vviewtab_store_button Gviewtab_print_information -TabStop Center w%store_button_w% h%controls_h% x%store_button_x% y%store_button_y%, Print
}
;=================================_====================================
;========================== Total Balance =============================
{
Gui, Add, Edit, Vviewtab_balance_edit ReadOnly -TabStop Center w%balance_edit_w% h%controls_h% x%balance_edit_x% y%balance_edit_y%
}
;=================================_====================================
;========================== Notes Control =============================
{
Gui, Add, Text, Vviewtab_notes_text_w w%notes_text_w% h%controls_h% x%notes_text_x% y%notes_text_y%, Note:

Gui, Add, Edit, Vviewtab_notes_edit ReadOnly r3 w%notes_edit_w% h%controls_h% x%notes_edit_x% y%notes_edit_y%
}
...
GuiControl, Choose, viewtab_date_ddl, 1 ; chooses last input record
gosub, viewtab_chosen_date ; updates gui
...
GuiControl, , viewtab_date_ddl, | ; clear control for new dates
...
{
	GuiControl, , viewtab_date_ddl, % date_array[reverse_counter] ; adds dates in reverse order
...
Loop, % date_array.Length() ; check every date
	...
	if InStr(date_array[A_Index], SubStr(date, 7, 2) . "/" . SubStr(date, 5, 2) . "/" . SubStr(date, 1, 4)) ; if date already input
	{
		...
		GuiControl, Choose, viewtab_date_ddl, % date_array[A_Index] ; autochooses date for view tab
		gosub, viewtab_chosen_date ; update gui
		GuiControl, Choose, tabs, View ; go to view tab
...
if date_array.Length() = 1
{
	...
	GuiControl, Choose, viewtab_date_ddl, 1 ; chooses only input record
}
else if date_array.Length() >= 2
{
	GuiControl, Choose, edittab_date_ddl, 2 ; chooses last input record before this one
	GuiControl, Choose, viewtab_date_ddl, 2 ; chooses last input record before this one
}
...
{
GuiControlGet, viewtab_currency_ddl_option, , viewtab_currency_ddl

if (viewtab_currency_ddl_option = "Euro")
{
	GuiControl, Hide, viewtab_kuna_bill_200_pic
	GuiControl, Hide, viewtab_kuna_bill_200_times_text
	GuiControl, Hide, viewtab_kuna_bill_200_edit

	GuiControl, Hide, viewtab_kuna_bill_100_pic
	GuiControl, Hide, viewtab_kuna_bill_100_times_text
	GuiControl, Hide, viewtab_kuna_bill_100_edit

	GuiControl, Hide, viewtab_kuna_bill_50_pic
	GuiControl, Hide, viewtab_kuna_bill_50_times_text
	GuiControl, Hide, viewtab_kuna_bill_50_edit

	GuiControl, Hide, viewtab_kuna_bill_20_pic
	GuiControl, Hide, viewtab_kuna_bill_20_times_text
	GuiControl, Hide, viewtab_kuna_bill_20_edit

	GuiControl, Hide, viewtab_kuna_bill_10_pic
	GuiControl, Hide, viewtab_kuna_bill_10_times_text
	GuiControl, Hide, viewtab_kuna_bill_10_edit

	GuiControl, Hide, viewtab_kuna_bills_sum_edit


	GuiControl, Hide, viewtab_kuna_bigcoin_5_pic
	GuiControl, Hide, viewtab_kuna_bigcoin_5_times_text
	GuiControl, Hide, viewtab_kuna_bigcoin_5_edit

	GuiControl, Hide, viewtab_kuna_bigcoin_2_pic
	GuiControl, Hide, viewtab_kuna_bigcoin_2_times_text
	GuiControl, Hide, viewtab_kuna_bigcoin_2_edit

	GuiControl, Hide, viewtab_kuna_bigcoin_1_pic
	GuiControl, Hide, viewtab_kuna_bigcoin_1_times_text
	GuiControl, Hide, viewtab_kuna_bigcoin_1_edit

	GuiControl, Hide, viewtab_kuna_bigcoins_sum_edit


	GuiControl, Hide, viewtab_kuna_smallcoin_50_pic
	GuiControl, Hide, viewtab_kuna_smallcoin_50_times_text
	GuiControl, Hide, viewtab_kuna_smallcoin_50_edit

	GuiControl, Hide, viewtab_kuna_smallcoin_20_pic
	GuiControl, Hide, viewtab_kuna_smallcoin_20_times_text
	GuiControl, Hide, viewtab_kuna_smallcoin_20_edit

	GuiControl, Hide, viewtab_kuna_smallcoin_10_pic
	GuiControl, Hide, viewtab_kuna_smallcoin_10_times_text
	GuiControl, Hide, viewtab_kuna_smallcoin_10_edit

	GuiControl, Hide, viewtab_kuna_smallcoin_5_pic
	GuiControl, Hide, viewtab_kuna_smallcoin_5_times_text
	GuiControl, Hide, viewtab_kuna_smallcoin_5_edit

	GuiControl, Hide, viewtab_kuna_smallcoin_1_pic
	GuiControl, Hide, viewtab_kuna_smallcoin_1_times_text
	GuiControl, Hide, viewtab_kuna_smallcoin_1_edit

	GuiControl, Hide, viewtab_kuna_smallcoins_sum_edit
	
	
	
	GuiControl, Show, viewtab_euro_bill_100_pic
	GuiControl, Show, viewtab_euro_bill_100_times_text
	GuiControl, Show, viewtab_euro_bill_100_edit

	GuiControl, Show, viewtab_euro_bill_50_pic
	GuiControl, Show, viewtab_euro_bill_50_times_text
	GuiControl, Show, viewtab_euro_bill_50_edit

	GuiControl, Show, viewtab_euro_bill_20_pic
	GuiControl, Show, viewtab_euro_bill_20_times_text
	GuiControl, Show, viewtab_euro_bill_20_edit

	GuiControl, Show, viewtab_euro_bill_10_pic
	GuiControl, Show, viewtab_euro_bill_10_times_text
	GuiControl, Show, viewtab_euro_bill_10_edit

	GuiControl, Show, viewtab_euro_bill_5_pic
	GuiControl, Show, viewtab_euro_bill_5_times_text
	GuiControl, Show, viewtab_euro_bill_5_edit

	GuiControl, Show, viewtab_euro_bills_sum_edit


	GuiControl, Show, viewtab_euro_bigcoin_2_pic
	GuiControl, Show, viewtab_euro_bigcoin_2_times_text
	GuiControl, Show, viewtab_euro_bigcoin_2_edit

	GuiControl, Show, viewtab_euro_bigcoin_1_pic
	GuiControl, Show, viewtab_euro_bigcoin_1_times_text
	GuiControl, Show, viewtab_euro_bigcoin_1_edit

	GuiControl, Show, viewtab_euro_bigcoins_sum_edit


	GuiControl, Show, viewtab_euro_smallcoin_50_pic
	GuiControl, Show, viewtab_euro_smallcoin_50_times_text
	GuiControl, Show, viewtab_euro_smallcoin_50_edit

	GuiControl, Show, viewtab_euro_smallcoin_20_pic
	GuiControl, Show, viewtab_euro_smallcoin_20_times_text
	GuiControl, Show, viewtab_euro_smallcoin_20_edit

	GuiControl, Show, viewtab_euro_smallcoin_10_pic
	GuiControl, Show, viewtab_euro_smallcoin_10_times_text
	GuiControl, Show, viewtab_euro_smallcoin_10_edit

	GuiControl, Show, viewtab_euro_smallcoin_5_pic
	GuiControl, Show, viewtab_euro_smallcoin_5_times_text
	GuiControl, Show, viewtab_euro_smallcoin_5_edit

	GuiControl, Show, viewtab_euro_smallcoin_1_pic
	GuiControl, Show, viewtab_euro_smallcoin_1_times_text
	GuiControl, Show, viewtab_euro_smallcoin_1_edit

	GuiControl, Show, viewtab_euro_smallcoins_sum_edit
}
else if (viewtab_currency_ddl_option = "Kuna")
{
	GuiControl, Show, viewtab_kuna_bill_200_pic
	GuiControl, Show, viewtab_kuna_bill_200_times_text
	GuiControl, Show, viewtab_kuna_bill_200_edit

	GuiControl, Show, viewtab_kuna_bill_100_pic
	GuiControl, Show, viewtab_kuna_bill_100_times_text
	GuiControl, Show, viewtab_kuna_bill_100_edit

	GuiControl, Show, viewtab_kuna_bill_50_pic
	GuiControl, Show, viewtab_kuna_bill_50_times_text
	GuiControl, Show, viewtab_kuna_bill_50_edit

	GuiControl, Show, viewtab_kuna_bill_20_pic
	GuiControl, Show, viewtab_kuna_bill_20_times_text
	GuiControl, Show, viewtab_kuna_bill_20_edit

	GuiControl, Show, viewtab_kuna_bill_10_pic
	GuiControl, Show, viewtab_kuna_bill_10_times_text
	GuiControl, Show, viewtab_kuna_bill_10_edit

	GuiControl, Show, viewtab_kuna_bills_sum_edit


	GuiControl, Show, viewtab_kuna_bigcoin_5_pic
	GuiControl, Show, viewtab_kuna_bigcoin_5_times_text
	GuiControl, Show, viewtab_kuna_bigcoin_5_edit

	GuiControl, Show, viewtab_kuna_bigcoin_2_pic
	GuiControl, Show, viewtab_kuna_bigcoin_2_times_text
	GuiControl, Show, viewtab_kuna_bigcoin_2_edit

	GuiControl, Show, viewtab_kuna_bigcoin_1_pic
	GuiControl, Show, viewtab_kuna_bigcoin_1_times_text
	GuiControl, Show, viewtab_kuna_bigcoin_1_edit

	GuiControl, Show, viewtab_kuna_bigcoins_sum_edit


	GuiControl, Show, viewtab_kuna_smallcoin_50_pic
	GuiControl, Show, viewtab_kuna_smallcoin_50_times_text
	GuiControl, Show, viewtab_kuna_smallcoin_50_edit

	GuiControl, Show, viewtab_kuna_smallcoin_20_pic
	GuiControl, Show, viewtab_kuna_smallcoin_20_times_text
	GuiControl, Show, viewtab_kuna_smallcoin_20_edit

	GuiControl, Show, viewtab_kuna_smallcoin_10_pic
	GuiControl, Show, viewtab_kuna_smallcoin_10_times_text
	GuiControl, Show, viewtab_kuna_smallcoin_10_edit

	GuiControl, Show, viewtab_kuna_smallcoin_5_pic
	GuiControl, Show, viewtab_kuna_smallcoin_5_times_text
	GuiControl, Show, viewtab_kuna_smallcoin_5_edit

	GuiControl, Show, viewtab_kuna_smallcoin_1_pic
	GuiControl, Show, viewtab_kuna_smallcoin_1_times_text
	GuiControl, Show, viewtab_kuna_smallcoin_1_edit

	GuiControl, Show, viewtab_kuna_smallcoins_sum_edit
	
	
	
	GuiControl, Hide, viewtab_euro_bill_100_pic
	GuiControl, Hide, viewtab_euro_bill_100_times_text
	GuiControl, Hide, viewtab_euro_bill_100_edit

	GuiControl, Hide, viewtab_euro_bill_50_pic
	GuiControl, Hide, viewtab_euro_bill_50_times_text
	GuiControl, Hide, viewtab_euro_bill_50_edit

	GuiControl, Hide, viewtab_euro_bill_20_pic
	GuiControl, Hide, viewtab_euro_bill_20_times_text
	GuiControl, Hide, viewtab_euro_bill_20_edit

	GuiControl, Hide, viewtab_euro_bill_10_pic
	GuiControl, Hide, viewtab_euro_bill_10_times_text
	GuiControl, Hide, viewtab_euro_bill_10_edit

	GuiControl, Hide, viewtab_euro_bill_5_pic
	GuiControl, Hide, viewtab_euro_bill_5_times_text
	GuiControl, Hide, viewtab_euro_bill_5_edit

	GuiControl, Hide, viewtab_euro_bills_sum_edit


	GuiControl, Hide, viewtab_euro_bigcoin_2_pic
	GuiControl, Hide, viewtab_euro_bigcoin_2_times_text
	GuiControl, Hide, viewtab_euro_bigcoin_2_edit

	GuiControl, Hide, viewtab_euro_bigcoin_1_pic
	GuiControl, Hide, viewtab_euro_bigcoin_1_times_text
	GuiControl, Hide, viewtab_euro_bigcoin_1_edit

	GuiControl, Hide, viewtab_euro_bigcoins_sum_edit


	GuiControl, Hide, viewtab_euro_smallcoin_50_pic
	GuiControl, Hide, viewtab_euro_smallcoin_50_times_text
	GuiControl, Hide, viewtab_euro_smallcoin_50_edit

	GuiControl, Hide, viewtab_euro_smallcoin_20_pic
	GuiControl, Hide, viewtab_euro_smallcoin_20_times_text
	GuiControl, Hide, viewtab_euro_smallcoin_20_edit

	GuiControl, Hide, viewtab_euro_smallcoin_10_pic
	GuiControl, Hide, viewtab_euro_smallcoin_10_times_text
	GuiControl, Hide, viewtab_euro_smallcoin_10_edit

	GuiControl, Hide, viewtab_euro_smallcoin_5_pic
	GuiControl, Hide, viewtab_euro_smallcoin_5_times_text
	GuiControl, Hide, viewtab_euro_smallcoin_5_edit

	GuiControl, Hide, viewtab_euro_smallcoin_1_pic
	GuiControl, Hide, viewtab_euro_smallcoin_1_times_text
	GuiControl, Hide, viewtab_euro_smallcoin_1_edit

	GuiControl, Hide, viewtab_euro_smallcoins_sum_edit
}
...
viewtab_chosen_date: ; retrieves info from "%A_ScriptDir%\Records\Records.txt" and displays it
{
GuiControl, Disable, viewtab_date_ddl ; disabled cause of spamming


GuiControlGet, viewtab_chosen_date, , viewtab_date_ddl
viewtab_chosen_date := StrSplit(viewtab_chosen_date, A_Space) ; get date
...
Loop, Read, %A_ScriptDir%\Records\Records.txt
	...
	If InStr(A_LoopReadLine, viewtab_chosen_date[2])
	{
		lock := "Unlocked"
		
		values := StrSplit(A_LoopReadLine, ",", A_Space)
		
		GuiControl, Text, viewtab_balance_edit, % values[2]
		GuiControl, Text, viewtab_kuna_edit, % values[3]
		GuiControl, Text, viewtab_euro_edit, % values[4]
		GuiControl, Text, viewtab_notes_edit, % values[37]
		GuiControl, Text, viewtab_bank_edit, % values[5]


		GuiControl, Text, viewtab_kuna_bill_200_edit, % values[9]
		GuiControl, Text, viewtab_kuna_bill_100_edit, % values[10]
		GuiControl, Text, viewtab_kuna_bill_50_edit, % values[11]
		GuiControl, Text, viewtab_kuna_bill_20_edit, % values[12]
		GuiControl, Text, viewtab_kuna_bill_10_edit, % values[13]

		GuiControl, Text, viewtab_kuna_bills_sum_edit, % values[6]


		GuiControl, Text, viewtab_kuna_bigcoin_5_edit, % values[14]
		GuiControl, Text, viewtab_kuna_bigcoin_2_edit, % values[15]
		GuiControl, Text, viewtab_kuna_bigcoin_1_edit, % values[16]

		GuiControl, Text, viewtab_kuna_bigcoins_sum_edit, % values[7]


		GuiControl, Text, viewtab_kuna_smallcoin_50_edit, % values[17]
		GuiControl, Text, viewtab_kuna_smallcoin_20_edit, % values[18]
		GuiControl, Text, viewtab_kuna_smallcoin_10_edit, % values[19]
		GuiControl, Text, viewtab_kuna_smallcoin_5_edit, % values[20]
		GuiControl, Text, viewtab_kuna_smallcoin_1_edit, % values[21]

		GuiControl, Text, viewtab_kuna_smallcoins_sum_edit, % values[8]



		GuiControl, Text, viewtab_euro_bill_100_edit, % values[25]
		GuiControl, Text, viewtab_euro_bill_50_edit, % values[26]
		GuiControl, Text, viewtab_euro_bill_20_edit, % values[27]
		GuiControl, Text, viewtab_euro_bill_10_edit, % values[28]
		GuiControl, Text, viewtab_euro_bill_5_edit, % values[29]

		GuiControl, Text, viewtab_euro_bills_sum_edit, % values[22]


		GuiControl, Text, viewtab_euro_bigcoin_2_edit, % values[30]
		GuiControl, Text, viewtab_euro_bigcoin_1_edit, % values[31]

		GuiControl, Text, viewtab_euro_bigcoins_sum_edit, % values[23]


		GuiControl, Text, viewtab_euro_smallcoin_50_edit, % values[32]
		GuiControl, Text, viewtab_euro_smallcoin_20_edit, % values[33]
		GuiControl, Text, viewtab_euro_smallcoin_10_edit, % values[34]
		GuiControl, Text, viewtab_euro_smallcoin_5_edit, % values[35]
		GuiControl, Text, viewtab_euro_smallcoin_1_edit, % values[36]

		GuiControl, Text, viewtab_euro_smallcoins_sum_edit, % values[24]
...
{
	GuiControl, Text, viewtab_balance_edit, 0.00
	GuiControl, Text, viewtab_kuna_edit, 0.00
	GuiControl, Text, viewtab_euro_edit, 0.00
	GuiControl, Text, viewtab_notes_edit, 
	GuiControl, Text, viewtab_bank_edit, 


	GuiControl, Text, viewtab_kuna_bill_200_edit, 
	GuiControl, Text, viewtab_kuna_bill_100_edit, 
	GuiControl, Text, viewtab_kuna_bill_50_edit, 
	GuiControl, Text, viewtab_kuna_bill_20_edit, 
	GuiControl, Text, viewtab_kuna_bill_10_edit, 

	GuiControl, Text, viewtab_kuna_bills_sum_edit, 0.00


	GuiControl, Text, viewtab_kuna_bigcoin_5_edit, 
	GuiControl, Text, viewtab_kuna_bigcoin_2_edit, 
	GuiControl, Text, viewtab_kuna_bigcoin_1_edit, 

	GuiControl, Text, viewtab_kuna_bigcoins_sum_edit, 0.00


	GuiControl, Text, viewtab_kuna_smallcoin_50_edit, 
	GuiControl, Text, viewtab_kuna_smallcoin_20_edit, 
	GuiControl, Text, viewtab_kuna_smallcoin_10_edit, 
	GuiControl, Text, viewtab_kuna_smallcoin_5_edit, 
	GuiControl, Text, viewtab_kuna_smallcoin_1_edit, 

	GuiControl, Text, viewtab_kuna_smallcoins_sum_edit, 0.00



	GuiControl, Text, viewtab_euro_bill_100_edit, 
	GuiControl, Text, viewtab_euro_bill_50_edit, 
	GuiControl, Text, viewtab_euro_bill_20_edit, 
	GuiControl, Text, viewtab_euro_bill_10_edit, 
	GuiControl, Text, viewtab_euro_bill_5_edit, 

	GuiControl, Text, viewtab_euro_bills_sum_edit, 0.00


	GuiControl, Text, viewtab_euro_bigcoin_2_edit, 
	GuiControl, Text, viewtab_euro_bigcoin_1_edit, 

	GuiControl, Text, viewtab_euro_bigcoins_sum_edit, 0.00


	GuiControl, Text, viewtab_euro_smallcoin_50_edit, 
	GuiControl, Text, viewtab_euro_smallcoin_20_edit, 
	GuiControl, Text, viewtab_euro_smallcoin_10_edit, 
	GuiControl, Text, viewtab_euro_smallcoin_5_edit, 
	GuiControl, Text, viewtab_euro_smallcoin_1_edit, 

	GuiControl, Text, viewtab_euro_smallcoins_sum_edit, 0.00
}


GuiControl, Enable, viewtab_date_ddl ; disabled cause of spamming
GuiControl, Focus, viewtab_date_ddl ; for continuation
}
return
...
if !InStr(viewtab_date_ddl, "Date:")
{
	MsgBox, 16, No Date Selected, You haven't selected a date.  `nPlease select a date to print.
}
else if InStr(viewtab_date_ddl, "Date:")
{
	current_string := "" ; needed cause of some bug
	...
	Loop, 37
	{
		if A_Index = 1
		{
			...
			control_string := viewtab_chosen_date[2]
		}
		else if A_Index = 2
		{
			pos := 21
			
			control_string := viewtab_balance_edit
		}			
		else if A_Index = 3
		{
			pos := 32
			
			control_string := viewtab_kuna_edit
		}			
		else if A_Index = 4
		{
			pos := 43
			
			control_string := viewtab_euro_edit
		}			
		else if A_Index = 5
		{
			pos := 53
			
			control_string := viewtab_bank_edit
		}			
		else if A_Index = 6
		{
			pos := 73
			
			control_string := viewtab_kuna_bills_sum_edit
		}				
		else if A_Index = 7
		{
			pos := 84
			
			control_string := viewtab_kuna_bigcoins_sum_edit
		}			
		else if A_Index = 8
		{
			pos := 91
			
			control_string := viewtab_kuna_smallcoins_sum_edit
		}			
		else if A_Index = 9
		{
			pos := 97
			
			control_string := viewtab_kuna_bill_200_edit
		}			
		else if A_Index = 10
		{
			pos := 103
			
			control_string := viewtab_kuna_bill_100_edit
		}			
		else if A_Index = 11
		{
			pos := 108
			
			control_string := viewtab_kuna_bill_50_edit
		}			
		else if A_Index = 12
		{
			pos := 113
			
			control_string := viewtab_kuna_bill_20_edit
		}
		else if A_Index = 13
		{
			pos := 118
			
			control_string := viewtab_kuna_bill_10_edit
		}			
		else if A_Index = 14
		{
			pos := 122
			
			control_string := viewtab_kuna_bigcoin_5_edit
		}			
		else if A_Index = 15
		{
			pos := 126
			
			control_string := viewtab_kuna_bigcoin_2_edit
		}			
		else if A_Index = 16
		{
			pos := 130
			
			control_string := viewtab_kuna_bigcoin_1_edit
		}			
		else if A_Index = 17
		{
			pos := 137
			
			control_string := viewtab_kuna_smallcoin_50_edit
		}			
		else if A_Index = 18
		{
			pos := 144
			
			control_string := viewtab_kuna_smallcoin_20_edit
		}			
		else if A_Index = 19
		{
			pos := 151
			
			control_string := viewtab_kuna_smallcoin_10_edit
		}			
		else if A_Index = 20
		{
			pos := 158
			
			control_string := viewtab_kuna_smallcoin_5_edit
		}			
		else if A_Index = 21
		{
			pos := 165
			
			control_string := viewtab_kuna_smallcoin_1_edit
		}			
		else if A_Index = 22
		{
			pos := 185
			
			control_string := viewtab_euro_bills_sum_edit
		}			
		else if A_Index = 23
		{
			pos := 196
			
			control_string := viewtab_euro_bigcoins_sum_edit
		}			
		else if A_Index = 24
		{
			pos := 204
			
			control_string := viewtab_euro_smallcoins_sum_edit
		}			
		else if A_Index = 25
		{
			pos := 210
			
			control_string := viewtab_euro_bill_100_edit
		}			
		else if A_Index = 26
		{
			pos := 216
			
			control_string := viewtab_euro_bill_50_edit
		}			
		else if A_Index = 27
		{
			pos := 221
			
			control_string := viewtab_euro_bill_20_edit
		}			
		else if A_Index = 28
		{
			pos := 226
			
			control_string := viewtab_euro_bill_10_edit
		}			
		else if A_Index = 29
		{
			pos := 231
			
			control_string := viewtab_euro_bill_5_edit
		}			
		else if A_Index = 30
		{
			pos := 235
			
			control_string := viewtab_euro_bigcoin_2_edit
		}			
		else if A_Index = 31
		{
			pos := 239
			
			control_string := viewtab_euro_bigcoin_1_edit
		}			
		else if A_Index = 32
		{
			pos := 243
			
			control_string := viewtab_euro_smallcoin_50_edit
		}			
		else if A_Index = 33
		{
			pos := 250
			
			control_string := viewtab_euro_smallcoin_20_edit
		}			
		else if A_Index = 34
		{
			pos := 257
			
			control_string := viewtab_euro_smallcoin_10_edit
		}			
		else if A_Index = 35
		{
			pos := 264
			
			control_string := viewtab_euro_smallcoin_5_edit
		}			
		else if A_Index = 36
		{
			pos := 271
			
			control_string := viewtab_euro_smallcoin_1_edit
		}			
		else if A_Index = 37
		{
			pos := 274 + StrLen(viewtab_notes_edit) ; no max lenght on note
			
			control_string := viewtab_notes_edit
		}
		...
		if (control_string != viewtab_notes_edit)
			current_string := current_string . control_string . ","
		else if (control_string = viewtab_notes_edit)
			current_string := current_string . control_string
