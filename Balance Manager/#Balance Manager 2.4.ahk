...
;=================================_====================================
/*
Gui, Add, Text, % "Vviewtab_third_currency_text " " -TabStop" " w" currency_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + currency_text_x " y" currency_text_y, Currency:

Gui, Add, DDL, % "Vviewtab_third_currency_ddl " Gviewtab_currency_ddl " "-TabStop " "Choose" 1 " w" currency_ddl_w " r" 2 " x" (tab_w + distance_to_border) * 2 + currency_ddl_x " y" currency_ddl_y, Kuna|Euro
*/
}
;=================================_====================================
;========================== Date Control ==============================
...
Gui, Add, DDL, % "Vviewtab_third_date_ddl " " Gviewtab_third_chosen_date " " w" date_ddl_w " r" 15 " x" (tab_w + distance_to_border) * 2 + date_ddl_x " y" date_ddl_y
}
;=================================_====================================
;========================= Bills Controls =============================
{
...
Gui, Add, Picture, % "Vviewtab_third_kuna_bill_200_pic " "ReadOnly " " -TabStop" " w" kuna_bill_200_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_200_pic_x " y" kuna_bill_200_pic_y, %A_ScriptDir%\Pictures\200 Kuna.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_bill_200_times_text " "ReadOnly " " -TabStop" " w" kuna_bill_200_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_200_times_text_x " y" kuna_bill_200_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bill_200_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bill_200_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_200_edit_x " y" kuna_bill_200_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bill_100_pic " "ReadOnly " " -TabStop" " w" kuna_bill_100_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_100_pic_x " y" kuna_bill_100_pic_y, %A_ScriptDir%\Pictures\100 Kuna.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_bill_100_times_text " "ReadOnly " " -TabStop" " w" kuna_bill_100_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_100_times_text_x " y" kuna_bill_100_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bill_100_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bill_100_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_100_edit_x " y" kuna_bill_100_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bill_50_pic " "ReadOnly " " -TabStop" " w" kuna_bill_50_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_50_pic_x " y" kuna_bill_50_pic_y, %A_ScriptDir%\Pictures\50 Kuna.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_bill_50_times_text " "ReadOnly " " -TabStop" " w" kuna_bill_50_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_50_times_text_x " y" kuna_bill_50_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bill_50_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bill_50_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_50_edit_x " y" kuna_bill_50_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bill_20_pic " "ReadOnly " " -TabStop" " w" kuna_bill_20_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_20_pic_x " y" kuna_bill_20_pic_y, %A_ScriptDir%\Pictures\20 Kuna.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_bill_20_times_text " "ReadOnly " " -TabStop" " w" kuna_bill_20_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_20_times_text_x " y" kuna_bill_20_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bill_20_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bill_20_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_20_edit_x " y" kuna_bill_20_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bill_10_pic " "ReadOnly " " -TabStop" " w" kuna_bill_10_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_10_pic_x " y" kuna_bill_10_pic_y, %A_ScriptDir%\Pictures\10 Kuna.png
Gui, Add, Text, % "Vviewtab_third_kuna_bill_10_times_text " "ReadOnly " " -TabStop" " w" kuna_bill_10_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_10_times_text_x " y" kuna_bill_10_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bill_10_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bill_10_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bill_10_edit_x " y" kuna_bill_10_edit_y

Gui, Add, Edit, % "Vviewtab_third_kuna_bills_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" kuna_bills_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bills_sum_edit_x " y" kuna_bills_sum_edit_y



Gui, Add, Picture, % "Vviewtab_third_euro_bill_100_pic " "ReadOnly " " -TabStop" " w" euro_bill_100_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_100_pic_x " y" euro_bill_100_pic_y, %A_ScriptDir%\Pictures\100 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bill_100_times_text " "ReadOnly " " -TabStop" " w" euro_bill_100_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_100_times_text_x " y" euro_bill_100_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bill_100_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bill_100_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_100_edit_x " y" euro_bill_100_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_bill_50_pic " "ReadOnly " " -TabStop" " w" euro_bill_50_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_50_pic_x " y" euro_bill_50_pic_y, %A_ScriptDir%\Pictures\50 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bill_50_times_text " "ReadOnly " " -TabStop" " w" euro_bill_50_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_50_times_text_x " y" euro_bill_50_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bill_50_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bill_50_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_50_edit_x " y" euro_bill_50_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_bill_20_pic " "ReadOnly " " -TabStop" " w" euro_bill_20_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_20_pic_x " y" euro_bill_20_pic_y, %A_ScriptDir%\Pictures\20 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bill_20_times_text " "ReadOnly " " -TabStop" " w" euro_bill_20_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_20_times_text_x " y" euro_bill_20_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bill_20_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bill_20_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_20_edit_x " y" euro_bill_20_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_bill_10_pic " "ReadOnly " " -TabStop" " w" euro_bill_10_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_10_pic_x " y" euro_bill_10_pic_y, %A_ScriptDir%\Pictures\10 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bill_10_times_text " "ReadOnly " " -TabStop" " w" euro_bill_10_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_10_times_text_x " y" euro_bill_10_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bill_10_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bill_10_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_10_edit_x " y" euro_bill_10_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_bill_5_pic " "ReadOnly " " -TabStop" " w" euro_bill_5_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_5_pic_x " y" euro_bill_5_pic_y, %A_ScriptDir%\Pictures\5 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bill_5_times_text " "ReadOnly " " -TabStop" " w" euro_bill_5_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_5_times_text_x " y" euro_bill_5_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bill_5_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bill_5_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bill_5_edit_x " y" euro_bill_5_edit_y

Gui, Add, Edit, % "Vviewtab_third_euro_bills_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" euro_bills_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bills_sum_edit_x " y" euro_bills_sum_edit_y
}
;=================================_====================================
;======================== Big Coins Controls ==========================
{
...
Gui, Add, Picture, % "Vviewtab_third_kuna_bigcoin_5_pic " "ReadOnly " " -TabStop" " w" kuna_bigcoin_5_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_5_pic_x " y" kuna_bigcoin_5_pic_y, %A_ScriptDir%\Pictures\5 Kuna.png
Gui, Add, Text, % "Vviewtab_third_kuna_bigcoin_5_times_text " "ReadOnly " " -TabStop" " w" kuna_bigcoin_5_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_5_times_text_x " y" kuna_bigcoin_5_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bigcoin_5_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bigcoin_5_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_5_edit_x " y" kuna_bigcoin_5_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bigcoin_2_pic " "ReadOnly " " -TabStop" " w" kuna_bigcoin_2_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_2_pic_x " y" kuna_bigcoin_2_pic_y, %A_ScriptDir%\Pictures\2 Kuna.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_bigcoin_2_times_text " "ReadOnly " " -TabStop" " w" kuna_bigcoin_2_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_2_times_text_x " y" kuna_bigcoin_2_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bigcoin_2_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bigcoin_2_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_2_edit_x " y" kuna_bigcoin_2_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_bigcoin_1_pic " "ReadOnly " " -TabStop" " w" kuna_bigcoin_1_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_1_pic_x " y" kuna_bigcoin_1_pic_y, %A_ScriptDir%\Pictures\1 Kuna.png
Gui, Add, Text, % "Vviewtab_third_kuna_bigcoin_1_times_text " "ReadOnly " " -TabStop" " w" kuna_bigcoin_1_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_1_times_text_x " y" kuna_bigcoin_1_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_bigcoin_1_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_bigcoin_1_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoin_1_edit_x " y" kuna_bigcoin_1_edit_y

Gui, Add, Edit, % "Vviewtab_third_kuna_bigcoins_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" kuna_bigcoins_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_bigcoins_sum_edit_x " y" kuna_bigcoins_sum_edit_y



Gui, Add, Picture, % "Vviewtab_third_euro_bigcoin_2_pic " "ReadOnly " " -TabStop" " w" euro_bigcoin_2_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_2_pic_x " y" euro_bigcoin_2_pic_y, %A_ScriptDir%\Pictures\2 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bigcoin_2_times_text " "ReadOnly " " -TabStop" " w" euro_bigcoin_2_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_2_times_text_x " y" euro_bigcoin_2_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bigcoin_2_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bigcoin_2_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_2_edit_x " y" euro_bigcoin_2_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_bigcoin_1_pic " "ReadOnly " " -TabStop" " w" euro_bigcoin_1_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_1_pic_x " y" euro_bigcoin_1_pic_y, %A_ScriptDir%\Pictures\1 Euro.jpg
Gui, Add, Text, % "Vviewtab_third_euro_bigcoin_1_times_text " "ReadOnly " " -TabStop" " w" euro_bigcoin_1_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_1_times_text_x " y" euro_bigcoin_1_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_bigcoin_1_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_bigcoin_1_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoin_1_edit_x " y" euro_bigcoin_1_edit_y

Gui, Add, Edit, % "Vviewtab_third_euro_bigcoins_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" euro_bigcoins_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_bigcoins_sum_edit_x " y" euro_bigcoins_sum_edit_y
}
;=================================_====================================
;======================= Small Coins Controls =========================
{
...
Gui, Add, Picture, % "Vviewtab_third_kuna_smallcoin_50_pic " "ReadOnly " " -TabStop" " w" kuna_smallcoin_50_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_50_pic_x " y" kuna_smallcoin_50_pic_y, %A_ScriptDir%\Pictures\50 Lipa.png
Gui, Add, Text, % "Vviewtab_third_kuna_smallcoin_50_times_text " "ReadOnly " " -TabStop" " w" kuna_smallcoin_50_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_50_times_text_x " y" kuna_smallcoin_50_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoin_50_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_smallcoin_50_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_50_edit_x " y" kuna_smallcoin_50_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_smallcoin_20_pic " "ReadOnly " " -TabStop" " w" kuna_smallcoin_20_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_20_pic_x " y" kuna_smallcoin_20_pic_y, %A_ScriptDir%\Pictures\20 Lipa.png
Gui, Add, Text, % "Vviewtab_third_kuna_smallcoin_20_times_text " "ReadOnly " " -TabStop" " w" kuna_smallcoin_20_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_20_times_text_x " y" kuna_smallcoin_20_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoin_20_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_smallcoin_20_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_20_edit_x " y" kuna_smallcoin_20_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_smallcoin_10_pic " "ReadOnly " " -TabStop" " w" kuna_smallcoin_10_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_10_pic_x " y" kuna_smallcoin_10_pic_y, %A_ScriptDir%\Pictures\10 Lipa.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_smallcoin_10_times_text " "ReadOnly " " -TabStop" " w" kuna_smallcoin_10_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_10_times_text_x " y" kuna_smallcoin_10_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoin_10_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_smallcoin_10_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_10_edit_x " y" kuna_smallcoin_10_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_smallcoin_5_pic " "ReadOnly " " -TabStop" " w" kuna_smallcoin_5_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_5_pic_x " y" kuna_smallcoin_5_pic_y, %A_ScriptDir%\Pictures\5 Lipa.png
Gui, Add, Text, % "Vviewtab_third_kuna_smallcoin_5_times_text " "ReadOnly " " -TabStop" " w" kuna_smallcoin_5_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_5_times_text_x " y" kuna_smallcoin_5_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoin_5_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_smallcoin_5_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_5_edit_x " y" kuna_smallcoin_5_edit_y

Gui, Add, Picture, % "Vviewtab_third_kuna_smallcoin_1_pic " "ReadOnly " " -TabStop" " w" kuna_smallcoin_1_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_1_pic_x " y" kuna_smallcoin_1_pic_y, %A_ScriptDir%\Pictures\1 Lipa.jpg
Gui, Add, Text, % "Vviewtab_third_kuna_smallcoin_1_times_text " "ReadOnly " " -TabStop" " w" kuna_smallcoin_1_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_1_times_text_x " y" kuna_smallcoin_1_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoin_1_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" kuna_smallcoin_1_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoin_1_edit_x " y" kuna_smallcoin_1_edit_y

Gui, Add, Edit, % "Vviewtab_third_kuna_smallcoins_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" kuna_smallcoins_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_smallcoins_sum_edit_x " y" kuna_smallcoins_sum_edit_y



Gui, Add, Picture, % "Vviewtab_third_euro_smallcoin_50_pic " "ReadOnly " " -TabStop" " w" euro_smallcoin_50_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_50_pic_x " y" euro_smallcoin_50_pic_y, %A_ScriptDir%\Pictures\50 Cents.jpg
Gui, Add, Text, % "Vviewtab_third_euro_smallcoin_50_times_text " "ReadOnly " " -TabStop" " w" euro_smallcoin_50_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_50_times_text_x " y" euro_smallcoin_50_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_smallcoin_50_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_smallcoin_50_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_50_edit_x " y" euro_smallcoin_50_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_smallcoin_20_pic " "ReadOnly " " -TabStop" " w" euro_smallcoin_20_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_20_pic_x " y" euro_smallcoin_20_pic_y, %A_ScriptDir%\Pictures\20 Cents.jpg
Gui, Add, Text, % "Vviewtab_third_euro_smallcoin_20_times_text " "ReadOnly " " -TabStop" " w" euro_smallcoin_20_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_20_times_text_x " y" euro_smallcoin_20_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_smallcoin_20_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_smallcoin_20_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_20_edit_x " y" euro_smallcoin_20_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_smallcoin_10_pic " "ReadOnly " " -TabStop" " w" euro_smallcoin_10_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_10_pic_x " y" euro_smallcoin_10_pic_y, %A_ScriptDir%\Pictures\10 Cents.jpg
Gui, Add, Text, % "Vviewtab_third_euro_smallcoin_10_times_text " "ReadOnly " " -TabStop" " w" euro_smallcoin_10_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_10_times_text_x " y" euro_smallcoin_10_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_smallcoin_10_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_smallcoin_10_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_10_edit_x " y" euro_smallcoin_10_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_smallcoin_5_pic " "ReadOnly " " -TabStop" " w" euro_smallcoin_5_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_5_pic_x " y" euro_smallcoin_5_pic_y, %A_ScriptDir%\Pictures\5 Cents.jpg
Gui, Add, Text, % "Vviewtab_third_euro_smallcoin_5_times_text " "ReadOnly " " -TabStop" " w" euro_smallcoin_5_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_5_times_text_x " y" euro_smallcoin_5_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_smallcoin_5_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_smallcoin_5_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_5_edit_x " y" euro_smallcoin_5_edit_y

Gui, Add, Picture, % "Vviewtab_third_euro_smallcoin_1_pic " "ReadOnly " " -TabStop" " w" euro_smallcoin_1_pic_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_1_pic_x " y" euro_smallcoin_1_pic_y, %A_ScriptDir%\Pictures\1 Cent.jpg
Gui, Add, Text, % "Vviewtab_third_euro_smallcoin_1_times_text " "ReadOnly " " -TabStop" " w" euro_smallcoin_1_times_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_1_times_text_x " y" euro_smallcoin_1_times_text_y, x
Gui, Add, Edit, % "Vviewtab_third_euro_smallcoin_1_edit " "ReadOnly " "Number" " Center" " -TabStop" " w" euro_smallcoin_1_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoin_1_edit_x " y" euro_smallcoin_1_edit_y

Gui, Add, Edit, % "Vviewtab_third_euro_smallcoins_sum_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" euro_smallcoins_sum_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_smallcoins_sum_edit_x " y" euro_smallcoins_sum_edit_y
}
;=================================_====================================
;========================== Bank Controls =============================
{
...
Gui, Add, Text, % "Vviewtab_third_bank_text " " -TabStop" " w" bank_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + bank_text_x " y" bank_text_y, Bank:

Gui, Add, Edit, % "Vviewtab_third_bank_edit " "ReadOnly " "Center" " -TabStop" " w" bank_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + bank_edit_x " y" bank_edit_y
}
;=================================_====================================
;======================= Calculation Controls =========================
{
...
Gui, Add, Text, % "Vviewtab_third_kuna_text " " -TabStop" " w" kuna_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_text_x " y" kuna_text_y, Kuna:

Gui, Add, Edit, % "Vviewtab_third_kuna_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" kuna_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + kuna_edit_x " y" kuna_edit_y


Gui, Add, Text, % "Vviewtab_third_euro_text " " -TabStop" " w" euro_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_text_x " y" euro_text_y, Euro:

Gui, Add, Edit, % "Vviewtab_third_euro_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" euro_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + euro_edit_x " y" euro_edit_y
}
;=================================_====================================
;========================== Select Button =============================
{
...
Gui, Add, Checkbox, % "Vviewtab_third_store_button " "0x1000 " "Center" " w" store_button_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + store_button_x " y" store_button_y, Select
}
;=================================_====================================
;========================== Total Balance =============================
{
...
Gui, Add, Edit, % "Vviewtab_third_balance_edit " "ReadOnly " "-TabStop " "Center" " -TabStop" " w" balance_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + balance_edit_x " y" balance_edit_y
}
;=================================_====================================
;========================== Notes Control =============================
{
...
Gui, Add, Text, % "Vviewtab_third_notes_text " " -TabStop" " w" notes_text_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + notes_text_x " y" notes_text_y, Note:

Gui, Add, Edit, % "Vviewtab_third_notes_edit " " ReadOnly " " -TabStop" " r" 3 " w" notes_edit_w " h" controls_h " x" (tab_w + distance_to_border) * 2 + notes_edit_x " y" notes_edit_y
}
...
GuiControl, Choose, viewtab_third_date_ddl, 3 ; chooses last input record
gosub, viewtab_third_chosen_date ; updates gui
...
GuiControl, Hide, viewtab_third_date_ddl
GuiControl, Hide, viewtab_third_bank_text
GuiControl, Hide, viewtab_third_bank_edit
GuiControl, Hide, viewtab_third_kuna_text
GuiControl, Hide, viewtab_third_kuna_edit
GuiControl, Hide, viewtab_third_euro_text
GuiControl, Hide, viewtab_third_euro_edit
GuiControl, Hide, viewtab_third_store_button
GuiControl, Hide, viewtab_third_balance_edit
GuiControl, Hide, viewtab_third_notes_text
GuiControl, Hide, viewtab_third_notes_edit
...
GuiControl, Hide, viewtab_third_kuna_bill_200_pic
GuiControl, Hide, viewtab_third_kuna_bill_200_times_text
GuiControl, Hide, viewtab_third_kuna_bill_200_edit

GuiControl, Hide, viewtab_third_kuna_bill_100_pic
GuiControl, Hide, viewtab_third_kuna_bill_100_times_text
GuiControl, Hide, viewtab_third_kuna_bill_100_edit

GuiControl, Hide, viewtab_third_kuna_bill_50_pic
GuiControl, Hide, viewtab_third_kuna_bill_50_times_text
GuiControl, Hide, viewtab_third_kuna_bill_50_edit

GuiControl, Hide, viewtab_third_kuna_bill_20_pic
GuiControl, Hide, viewtab_third_kuna_bill_20_times_text
GuiControl, Hide, viewtab_third_kuna_bill_20_edit

GuiControl, Hide, viewtab_third_kuna_bill_10_pic
GuiControl, Hide, viewtab_third_kuna_bill_10_times_text
GuiControl, Hide, viewtab_third_kuna_bill_10_edit

GuiControl, Hide, viewtab_third_kuna_bills_sum_edit


GuiControl, Hide, viewtab_third_kuna_bigcoin_5_pic
GuiControl, Hide, viewtab_third_kuna_bigcoin_5_times_text
GuiControl, Hide, viewtab_third_kuna_bigcoin_5_edit

GuiControl, Hide, viewtab_third_kuna_bigcoin_2_pic
GuiControl, Hide, viewtab_third_kuna_bigcoin_2_times_text
GuiControl, Hide, viewtab_third_kuna_bigcoin_2_edit

GuiControl, Hide, viewtab_third_kuna_bigcoin_1_pic
GuiControl, Hide, viewtab_third_kuna_bigcoin_1_times_text
GuiControl, Hide, viewtab_third_kuna_bigcoin_1_edit

GuiControl, Hide, viewtab_third_kuna_bigcoins_sum_edit


GuiControl, Hide, viewtab_third_kuna_smallcoin_50_pic
GuiControl, Hide, viewtab_third_kuna_smallcoin_50_times_text
GuiControl, Hide, viewtab_third_kuna_smallcoin_50_edit

GuiControl, Hide, viewtab_third_kuna_smallcoin_20_pic
GuiControl, Hide, viewtab_third_kuna_smallcoin_20_times_text
GuiControl, Hide, viewtab_third_kuna_smallcoin_20_edit

GuiControl, Hide, viewtab_third_kuna_smallcoin_10_pic
GuiControl, Hide, viewtab_third_kuna_smallcoin_10_times_text
GuiControl, Hide, viewtab_third_kuna_smallcoin_10_edit

GuiControl, Hide, viewtab_third_kuna_smallcoin_5_pic
GuiControl, Hide, viewtab_third_kuna_smallcoin_5_times_text
GuiControl, Hide, viewtab_third_kuna_smallcoin_5_edit

GuiControl, Hide, viewtab_third_kuna_smallcoin_1_pic
GuiControl, Hide, viewtab_third_kuna_smallcoin_1_times_text
GuiControl, Hide, viewtab_third_kuna_smallcoin_1_edit

GuiControl, Hide, viewtab_third_kuna_smallcoins_sum_edit



GuiControl, Hide, viewtab_third_euro_bill_100_pic
GuiControl, Hide, viewtab_third_euro_bill_100_times_text
GuiControl, Hide, viewtab_third_euro_bill_100_edit

GuiControl, Hide, viewtab_third_euro_bill_50_pic
GuiControl, Hide, viewtab_third_euro_bill_50_times_text
GuiControl, Hide, viewtab_third_euro_bill_50_edit

GuiControl, Hide, viewtab_third_euro_bill_20_pic
GuiControl, Hide, viewtab_third_euro_bill_20_times_text
GuiControl, Hide, viewtab_third_euro_bill_20_edit

GuiControl, Hide, viewtab_third_euro_bill_10_pic
GuiControl, Hide, viewtab_third_euro_bill_10_times_text
GuiControl, Hide, viewtab_third_euro_bill_10_edit

GuiControl, Hide, viewtab_third_euro_bill_5_pic
GuiControl, Hide, viewtab_third_euro_bill_5_times_text
GuiControl, Hide, viewtab_third_euro_bill_5_edit

GuiControl, Hide, viewtab_third_euro_bills_sum_edit


GuiControl, Hide, viewtab_third_euro_bigcoin_2_pic
GuiControl, Hide, viewtab_third_euro_bigcoin_2_times_text
GuiControl, Hide, viewtab_third_euro_bigcoin_2_edit

GuiControl, Hide, viewtab_third_euro_bigcoin_1_pic
GuiControl, Hide, viewtab_third_euro_bigcoin_1_times_text
GuiControl, Hide, viewtab_third_euro_bigcoin_1_edit

GuiControl, Hide, viewtab_third_euro_bigcoins_sum_edit


GuiControl, Hide, viewtab_third_euro_smallcoin_50_pic
GuiControl, Hide, viewtab_third_euro_smallcoin_50_times_text
GuiControl, Hide, viewtab_third_euro_smallcoin_50_edit

GuiControl, Hide, viewtab_third_euro_smallcoin_20_pic
GuiControl, Hide, viewtab_third_euro_smallcoin_20_times_text
GuiControl, Hide, viewtab_third_euro_smallcoin_20_edit

GuiControl, Hide, viewtab_third_euro_smallcoin_10_pic
GuiControl, Hide, viewtab_third_euro_smallcoin_10_times_text
GuiControl, Hide, viewtab_third_euro_smallcoin_10_edit

GuiControl, Hide, viewtab_third_euro_smallcoin_5_pic
GuiControl, Hide, viewtab_third_euro_smallcoin_5_times_text
GuiControl, Hide, viewtab_third_euro_smallcoin_5_edit

GuiControl, Hide, viewtab_third_euro_smallcoin_1_pic
GuiControl, Hide, viewtab_third_euro_smallcoin_1_times_text
GuiControl, Hide, viewtab_third_euro_smallcoin_1_edit

GuiControl, Hide, viewtab_third_euro_smallcoins_sum_edit
}
...
{
	GuiControl, Move, Tabs, % "w" window_w * 3 - distance_to_border
	
	Loop, 100
	{
		current_w := current_w + 8.8
		
		current_x := current_x - (8.8 / 2)
	...
	GuiControl, Show, viewtab_third_date_ddl
	GuiControl, Show, viewtab_third_bank_text
	GuiControl, Show, viewtab_third_bank_edit
	GuiControl, Show, viewtab_third_kuna_text
	GuiControl, Show, viewtab_third_kuna_edit
	GuiControl, Show, viewtab_third_euro_text
	GuiControl, Show, viewtab_third_euro_edit
	GuiControl, Show, viewtab_third_store_button
	GuiControl, Show, viewtab_third_balance_edit
	GuiControl, Show, viewtab_third_notes_text
	GuiControl, Show, viewtab_third_notes_edit
...
{	
	WinGetPos, current_x, , , , Balance Manager ; save position of window when resizing
...
GuiControl, , viewtab_third_date_ddl, | ; clear control for new dates
...
Loop, % date_array.Length()
{
	...
	GuiControl, , viewtab_third_date_ddl, % date_array[reverse_counter] ; adds dates in reverse order
...
if !FileExist("Records\Records.txt")
	FileAppend, `nDate:        Balance:      Kuna:      Euro:     Bank:   Kuna:  Novčanice:  Kovanice:  Lipe:  200:  100:  50:  20:  10:  5:  2:  1:  0.50:  0.20:  0.10:  0.05:  0.01:   Euro:  Novčanice:  Kovanice:  Centi:  100:  50:  20:  10:  5:  2:  1:  0.50:  0.20:  0.10:  0.05:  0.01:  Note:`n, %A_ScriptDir%\Records\Records.txt
...
GuiControl, Choose, viewtab_third_date_ddl, 3 ; chooses third record


gosub, viewtab_first_chosen_date ; update gui
gosub, viewtab_second_chosen_date ; update gui
gosub, viewtab_third_chosen_date ; update gui
...
if (viewtab_currency_ddl_option = "Euro")
{
	...
	GuiControl, Show, viewtab_third_euro_bill_100_pic
	GuiControl, Show, viewtab_third_euro_bill_100_times_text
	GuiControl, Show, viewtab_third_euro_bill_100_edit

	GuiControl, Show, viewtab_third_euro_bill_50_pic
	GuiControl, Show, viewtab_third_euro_bill_50_times_text
	GuiControl, Show, viewtab_third_euro_bill_50_edit

	GuiControl, Show, viewtab_third_euro_bill_20_pic
	GuiControl, Show, viewtab_third_euro_bill_20_times_text
	GuiControl, Show, viewtab_third_euro_bill_20_edit

	GuiControl, Show, viewtab_third_euro_bill_10_pic
	GuiControl, Show, viewtab_third_euro_bill_10_times_text
	GuiControl, Show, viewtab_third_euro_bill_10_edit

	GuiControl, Show, viewtab_third_euro_bill_5_pic
	GuiControl, Show, viewtab_third_euro_bill_5_times_text
	GuiControl, Show, viewtab_third_euro_bill_5_edit

	GuiControl, Show, viewtab_third_euro_bills_sum_edit


	GuiControl, Show, viewtab_third_euro_bigcoin_2_pic
	GuiControl, Show, viewtab_third_euro_bigcoin_2_times_text
	GuiControl, Show, viewtab_third_euro_bigcoin_2_edit

	GuiControl, Show, viewtab_third_euro_bigcoin_1_pic
	GuiControl, Show, viewtab_third_euro_bigcoin_1_times_text
	GuiControl, Show, viewtab_third_euro_bigcoin_1_edit

	GuiControl, Show, viewtab_third_euro_bigcoins_sum_edit


	GuiControl, Show, viewtab_third_euro_smallcoin_50_pic
	GuiControl, Show, viewtab_third_euro_smallcoin_50_times_text
	GuiControl, Show, viewtab_third_euro_smallcoin_50_edit

	GuiControl, Show, viewtab_third_euro_smallcoin_20_pic
	GuiControl, Show, viewtab_third_euro_smallcoin_20_times_text
	GuiControl, Show, viewtab_third_euro_smallcoin_20_edit

	GuiControl, Show, viewtab_third_euro_smallcoin_10_pic
	GuiControl, Show, viewtab_third_euro_smallcoin_10_times_text
	GuiControl, Show, viewtab_third_euro_smallcoin_10_edit

	GuiControl, Show, viewtab_third_euro_smallcoin_5_pic
	GuiControl, Show, viewtab_third_euro_smallcoin_5_times_text
	GuiControl, Show, viewtab_third_euro_smallcoin_5_edit

	GuiControl, Show, viewtab_third_euro_smallcoin_1_pic
	GuiControl, Show, viewtab_third_euro_smallcoin_1_times_text
	GuiControl, Show, viewtab_third_euro_smallcoin_1_edit

	GuiControl, Show, viewtab_third_euro_smallcoins_sum_edit
}
else if (viewtab_currency_ddl_option = "Kuna")
{
	...
	GuiControl, Show, viewtab_third_kuna_bill_200_pic
	GuiControl, Show, viewtab_third_kuna_bill_200_times_text
	GuiControl, Show, viewtab_third_kuna_bill_200_edit

	GuiControl, Show, viewtab_third_kuna_bill_100_pic
	GuiControl, Show, viewtab_third_kuna_bill_100_times_text
	GuiControl, Show, viewtab_third_kuna_bill_100_edit

	GuiControl, Show, viewtab_third_kuna_bill_50_pic
	GuiControl, Show, viewtab_third_kuna_bill_50_times_text
	GuiControl, Show, viewtab_third_kuna_bill_50_edit

	GuiControl, Show, viewtab_third_kuna_bill_20_pic
	GuiControl, Show, viewtab_third_kuna_bill_20_times_text
	GuiControl, Show, viewtab_third_kuna_bill_20_edit

	GuiControl, Show, viewtab_third_kuna_bill_10_pic
	GuiControl, Show, viewtab_third_kuna_bill_10_times_text
	GuiControl, Show, viewtab_third_kuna_bill_10_edit

	GuiControl, Show, viewtab_third_kuna_bills_sum_edit


	GuiControl, Show, viewtab_third_kuna_bigcoin_5_pic
	GuiControl, Show, viewtab_third_kuna_bigcoin_5_times_text
	GuiControl, Show, viewtab_third_kuna_bigcoin_5_edit

	GuiControl, Show, viewtab_third_kuna_bigcoin_2_pic
	GuiControl, Show, viewtab_third_kuna_bigcoin_2_times_text
	GuiControl, Show, viewtab_third_kuna_bigcoin_2_edit

	GuiControl, Show, viewtab_third_kuna_bigcoin_1_pic
	GuiControl, Show, viewtab_third_kuna_bigcoin_1_times_text
	GuiControl, Show, viewtab_third_kuna_bigcoin_1_edit

	GuiControl, Show, viewtab_third_kuna_bigcoins_sum_edit


	GuiControl, Show, viewtab_third_kuna_smallcoin_50_pic
	GuiControl, Show, viewtab_third_kuna_smallcoin_50_times_text
	GuiControl, Show, viewtab_third_kuna_smallcoin_50_edit

	GuiControl, Show, viewtab_third_kuna_smallcoin_20_pic
	GuiControl, Show, viewtab_third_kuna_smallcoin_20_times_text
	GuiControl, Show, viewtab_third_kuna_smallcoin_20_edit

	GuiControl, Show, viewtab_third_kuna_smallcoin_10_pic
	GuiControl, Show, viewtab_third_kuna_smallcoin_10_times_text
	GuiControl, Show, viewtab_third_kuna_smallcoin_10_edit

	GuiControl, Show, viewtab_third_kuna_smallcoin_5_pic
	GuiControl, Show, viewtab_third_kuna_smallcoin_5_times_text
	GuiControl, Show, viewtab_third_kuna_smallcoin_5_edit

	GuiControl, Show, viewtab_third_kuna_smallcoin_1_pic
	GuiControl, Show, viewtab_third_kuna_smallcoin_1_times_text
	GuiControl, Show, viewtab_third_kuna_smallcoin_1_edit

	GuiControl, Show, viewtab_third_kuna_smallcoins_sum_edit
...
viewtab_third_chosen_date: ; retrieves info from "%A_ScriptDir%\Records\Records.txt" and displays it
{
GuiControl, Disable, viewtab_third_date_ddl ; disabled cause of spamming


GuiControlGet, viewtab_third_chosen_date, , viewtab_third_date_ddl
viewtab_third_chosen_date := StrSplit(viewtab_third_chosen_date, A_Space) ; get date
...
Loop, Read, %A_ScriptDir%\Records\Records.txt
	...
	If InStr(A_LoopReadLine, viewtab_third_chosen_date[2])
	{
		lock := "Unlocked"
		
		values := StrSplit(A_LoopReadLine, ",", A_Space)
		
		GuiControl, Text, viewtab_third_balance_edit, % values[2]
		GuiControl, Text, viewtab_third_kuna_edit, % values[3]
		GuiControl, Text, viewtab_third_euro_edit, % values[4]
		GuiControl, Text, viewtab_third_notes_edit, % values[37]
		GuiControl, Text, viewtab_third_bank_edit, % values[5]


		GuiControl, Text, viewtab_third_kuna_bill_200_edit, % values[9]
		GuiControl, Text, viewtab_third_kuna_bill_100_edit, % values[10]
		GuiControl, Text, viewtab_third_kuna_bill_50_edit, % values[11]
		GuiControl, Text, viewtab_third_kuna_bill_20_edit, % values[12]
		GuiControl, Text, viewtab_third_kuna_bill_10_edit, % values[13]

		GuiControl, Text, viewtab_third_kuna_bills_sum_edit, % values[6]


		GuiControl, Text, viewtab_third_kuna_bigcoin_5_edit, % values[14]
		GuiControl, Text, viewtab_third_kuna_bigcoin_2_edit, % values[15]
		GuiControl, Text, viewtab_third_kuna_bigcoin_1_edit, % values[16]

		GuiControl, Text, viewtab_third_kuna_bigcoins_sum_edit, % values[7]


		GuiControl, Text, viewtab_third_kuna_smallcoin_50_edit, % values[17]
		GuiControl, Text, viewtab_third_kuna_smallcoin_20_edit, % values[18]
		GuiControl, Text, viewtab_third_kuna_smallcoin_10_edit, % values[19]
		GuiControl, Text, viewtab_third_kuna_smallcoin_5_edit, % values[20]
		GuiControl, Text, viewtab_third_kuna_smallcoin_1_edit, % values[21]

		GuiControl, Text, viewtab_third_kuna_smallcoins_sum_edit, % values[8]



		GuiControl, Text, viewtab_third_euro_bill_100_edit, % values[25]
		GuiControl, Text, viewtab_third_euro_bill_50_edit, % values[26]
		GuiControl, Text, viewtab_third_euro_bill_20_edit, % values[27]
		GuiControl, Text, viewtab_third_euro_bill_10_edit, % values[28]
		GuiControl, Text, viewtab_third_euro_bill_5_edit, % values[29]

		GuiControl, Text, viewtab_third_euro_bills_sum_edit, % values[22]


		GuiControl, Text, viewtab_third_euro_bigcoin_2_edit, % values[30]
		GuiControl, Text, viewtab_third_euro_bigcoin_1_edit, % values[31]

		GuiControl, Text, viewtab_third_euro_bigcoins_sum_edit, % values[23]


		GuiControl, Text, viewtab_third_euro_smallcoin_50_edit, % values[32]
		GuiControl, Text, viewtab_third_euro_smallcoin_20_edit, % values[33]
		GuiControl, Text, viewtab_third_euro_smallcoin_10_edit, % values[34]
		GuiControl, Text, viewtab_third_euro_smallcoin_5_edit, % values[35]
		GuiControl, Text, viewtab_third_euro_smallcoin_1_edit, % values[36]

		GuiControl, Text, viewtab_third_euro_smallcoins_sum_edit, % values[24]
...
If (lock = "Locked") ; clear all 
{
	GuiControl, Text, viewtab_third_balance_edit, 0.00
	GuiControl, Text, viewtab_third_kuna_edit, 0.00
	GuiControl, Text, viewtab_third_euro_edit, 0.00
	GuiControl, Text, viewtab_third_notes_edit, 
	GuiControl, Text, viewtab_third_bank_edit, 


	GuiControl, Text, viewtab_third_kuna_bill_200_edit, 
	GuiControl, Text, viewtab_third_kuna_bill_100_edit, 
	GuiControl, Text, viewtab_third_kuna_bill_50_edit, 
	GuiControl, Text, viewtab_third_kuna_bill_20_edit, 
	GuiControl, Text, viewtab_third_kuna_bill_10_edit, 

	GuiControl, Text, viewtab_third_kuna_bills_sum_edit, 0.00


	GuiControl, Text, viewtab_third_kuna_bigcoin_5_edit, 
	GuiControl, Text, viewtab_third_kuna_bigcoin_2_edit, 
	GuiControl, Text, viewtab_third_kuna_bigcoin_1_edit, 

	GuiControl, Text, viewtab_third_kuna_bigcoins_sum_edit, 0.00


	GuiControl, Text, viewtab_third_kuna_smallcoin_50_edit, 
	GuiControl, Text, viewtab_third_kuna_smallcoin_20_edit, 
	GuiControl, Text, viewtab_third_kuna_smallcoin_10_edit, 
	GuiControl, Text, viewtab_third_kuna_smallcoin_5_edit, 
	GuiControl, Text, viewtab_third_kuna_smallcoin_1_edit, 

	GuiControl, Text, viewtab_third_kuna_smallcoins_sum_edit, 0.00



	GuiControl, Text, viewtab_third_euro_bill_100_edit, 
	GuiControl, Text, viewtab_third_euro_bill_50_edit, 
	GuiControl, Text, viewtab_third_euro_bill_20_edit, 
	GuiControl, Text, viewtab_third_euro_bill_10_edit, 
	GuiControl, Text, viewtab_third_euro_bill_5_edit, 

	GuiControl, Text, viewtab_third_euro_bills_sum_edit, 0.00


	GuiControl, Text, viewtab_third_euro_bigcoin_2_edit, 
	GuiControl, Text, viewtab_third_euro_bigcoin_1_edit, 

	GuiControl, Text, viewtab_third_euro_bigcoins_sum_edit, 0.00


	GuiControl, Text, viewtab_third_euro_smallcoin_50_edit, 
	GuiControl, Text, viewtab_third_euro_smallcoin_20_edit, 
	GuiControl, Text, viewtab_third_euro_smallcoin_10_edit, 
	GuiControl, Text, viewtab_third_euro_smallcoin_5_edit, 
	GuiControl, Text, viewtab_third_euro_smallcoin_1_edit, 

	GuiControl, Text, viewtab_third_euro_smallcoins_sum_edit, 0.00
}


GuiControl, Enable, viewtab_third_date_ddl ; disabled cause of spamming
GuiControl, Focus, viewtab_third_date_ddl ; for continuation
}
return
...
if !viewtab_first_store_button and !viewtab_second_store_button and !viewtab_third_store_button
{
	MsgBox, 16, No Files Selected, You haven't selected a file. Please `nselect one or more files to print.
}
else if viewtab_first_store_button and InStr(viewtab_first_date_ddl, "Date:") or viewtab_second_store_button and InStr(viewtab_second_date_ddl, "Date:") or viewtab_third_store_button and InStr(viewtab_third_date_ddl, "Date:")
{
	if FileExist("Records\Records - Print.txt")
		FileDelete, %A_ScriptDir%\Records\Records - Print.txt


	FileAppend, `nDate:        Balance:      Kuna:      Euro:     Bank:   Kuna:  Novčanice:  Kovanice:  Lipe:  200:  100:  50:  20:  10:  5:  2:  1:  0.50:  0.20:  0.10:  0.05:  0.01:   Euro:  Novčanice:  Kovanice:  Centi:  100:  50:  20:  10:  5:  2:  1:  0.50:  0.20:  0.10:  0.05:  0.01:  Note:`n, %A_ScriptDir%\Records\Records - Print.txt
	...
	if viewtab_third_store_button and InStr(viewtab_third_date_ddl, "Date:")
	{
		current_string := ""
		...
		Loop, 37
		{
			if A_Index = 1
			{
				...
				control_string := viewtab_third_chosen_date[2]
			}
			else if A_Index = 2
			{
				pos := 21
				
				control_string := viewtab_third_balance_edit
			}			
			else if A_Index = 3
			{
				pos := 32
				
				control_string := viewtab_third_kuna_edit
			}			
			else if A_Index = 4
			{
				pos := 43
				
				control_string := viewtab_third_euro_edit
			}			
			else if A_Index = 5
			{
				pos := 53
				
				control_string := viewtab_third_bank_edit
			}			
			else if A_Index = 6
			{
				pos := 73
				
				control_string := viewtab_third_kuna_bills_sum_edit
			}				
			else if A_Index = 7
			{
				pos := 84
				
				control_string := viewtab_third_kuna_bigcoins_sum_edit
			}			
			else if A_Index = 8
			{
				pos := 91
				
				control_string := viewtab_third_kuna_smallcoins_sum_edit
			}			
			else if A_Index = 9
			{
				pos := 97
				
				control_string := viewtab_third_kuna_bill_200_edit
			}			
			else if A_Index = 10
			{
				pos := 103
				
				control_string := viewtab_third_kuna_bill_100_edit
			}			
			else if A_Index = 11
			{
				pos := 108
				
				control_string := viewtab_third_kuna_bill_50_edit
			}			
			else if A_Index = 12
			{
				pos := 113
				
				control_string := viewtab_third_kuna_bill_20_edit
			}
			else if A_Index = 13
			{
				pos := 118
				
				control_string := viewtab_third_kuna_bill_10_edit
			}			
			else if A_Index = 14
			{
				pos := 122
				
				control_string := viewtab_third_kuna_bigcoin_5_edit
			}			
			else if A_Index = 15
			{
				pos := 126
				
				control_string := viewtab_third_kuna_bigcoin_2_edit
			}			
			else if A_Index = 16
			{
				pos := 130
				
				control_string := viewtab_third_kuna_bigcoin_1_edit
			}			
			else if A_Index = 17
			{
				pos := 137
				
				control_string := viewtab_third_kuna_smallcoin_50_edit
			}			
			else if A_Index = 18
			{
				pos := 144
				
				control_string := viewtab_third_kuna_smallcoin_20_edit
			}			
			else if A_Index = 19
			{
				pos := 151
				
				control_string := viewtab_third_kuna_smallcoin_10_edit
			}			
			else if A_Index = 20
			{
				pos := 158
				
				control_string := viewtab_third_kuna_smallcoin_5_edit
			}			
			else if A_Index = 21
			{
				pos := 165
				
				control_string := viewtab_third_kuna_smallcoin_1_edit
			}			
			else if A_Index = 22
			{
				pos := 185
				
				control_string := viewtab_third_euro_bills_sum_edit
			}			
			else if A_Index = 23
			{
				pos := 196
				
				control_string := viewtab_third_euro_bigcoins_sum_edit
			}			
			else if A_Index = 24
			{
				pos := 204
				
				control_string := viewtab_third_euro_smallcoins_sum_edit
			}			
			else if A_Index = 25
			{
				pos := 210
				
				control_string := viewtab_third_euro_bill_100_edit
			}			
			else if A_Index = 26
			{
				pos := 216
				
				control_string := viewtab_third_euro_bill_50_edit
			}			
			else if A_Index = 27
			{
				pos := 221
				
				control_string := viewtab_third_euro_bill_20_edit
			}			
			else if A_Index = 28
			{
				pos := 226
				
				control_string := viewtab_third_euro_bill_10_edit
			}			
			else if A_Index = 29
			{
				pos := 231
				
				control_string := viewtab_third_euro_bill_5_edit
			}			
			else if A_Index = 30
			{
				pos := 235
				
				control_string := viewtab_third_euro_bigcoin_2_edit
			}			
			else if A_Index = 31
			{
				pos := 239
				
				control_string := viewtab_third_euro_bigcoin_1_edit
			}			
			else if A_Index = 32
			{
				pos := 243
				
				control_string := viewtab_third_euro_smallcoin_50_edit
			}			
			else if A_Index = 33
			{
				pos := 250
				
				control_string := viewtab_third_euro_smallcoin_20_edit
			}			
			else if A_Index = 34
			{
				pos := 257
				
				control_string := viewtab_third_euro_smallcoin_10_edit
			}			
			else if A_Index = 35
			{
				pos := 264
				
				control_string := viewtab_third_euro_smallcoin_5_edit
			}			
			else if A_Index = 36
			{
				pos := 271
				
				control_string := viewtab_third_euro_smallcoin_1_edit
			}			
			else if A_Index = 37
			{
				pos := 274 + StrLen(viewtab_third_notes_edit) ; no max lenght on note
				
				control_string := viewtab_third_notes_edit
			}
			...
			if (control_string != viewtab_third_notes_edit)
				current_string := current_string . control_string . ","
			else if (control_string = viewtab_third_notes_edit)
				current_string := current_string . control_string
...
else if !InStr(viewtab_first_date_ddl, "Date:") and !InStr(viewtab_second_date_ddl, "Date:") and !InStr(viewtab_third_date_ddl, "Date:")
{
...
GuiControl, , viewtab_third_store_button, 0
